...
import profilePic from '../assets/Gerijek Opiyo.jpg'
  ...
  return <div className='border-b border-neutral-900 pb-4 lg:mb-35'>
    <div className='flex flex-wrap'>
        ...
        <div className='flex flex-col items-center lg:items-start'>
            ...
            initial='hidden'
            animate='visible' 
            className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Gerijek Opiyo</motion.h1>
         <motion.span 
        ...
        <div className='flex justify-center'>
            ...
            <img src={profilePic} alt="My AI generator image " />
        </div>
